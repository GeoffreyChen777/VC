...
class ResUnit(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, inner_channels) -> None:
        ...
        self.conv1 = conv1x1(in_channels, inner_channels)
        self.conv2 = conv3x3(inner_channels, inner_channels, 1, 1)
        self.conv3 = conv1x1(inner_channels, out_channels)
...
class FrozenBatchNorm2d(nn.Module):
    ...
    def forward(self, x):
        if x.requires_grad:
            ...
            return F.batch_norm(
                x, self.running_mean, self.running_var, self.weight, self.bias, training=False, eps=self.eps
            )
...
class DropBlock2D(nn.Module):
    ...
    def forward(self, x):
        ...
        if not self.training or self.drop_prob == 0.0 or x.numel() == 0:
            return x
        else:
            # get gamma value
