...
def get_version():
    init_py_path = path.join(path.abspath(path.dirname(__file__)), "fastevalapi", "__init__.py")
...
def get_extensions():
    ...
    extensions_dir = path.join(this_dir, "fastevalapi", "csrc")
...
setup(
    ...
    version=get_version(),
    author="FAIR",
    url="https://github.com/facebookresearch/fastevalapi",
